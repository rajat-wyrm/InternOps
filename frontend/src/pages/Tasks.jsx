...
export default function Tasks() {
  ...
  const submitMutation = useMutation({
    mutationFn: ({ taskId, file, actions }) => {
      ...
      // Append tracking values as strings to FormData
    ...
    onSuccess: () => {
      ...
      // Reset checkboxes on successful submit
      setDidComment(false);
      setDidRepost(false);
      setDidShare(false);
    }, 
