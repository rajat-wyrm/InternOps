...
export default function Tasks() {
  ...
  // Checkbox management states for proof tracking
  ...
  const submitMutation = useMutation({
    mutationFn: ({ taskId, file, actions }) => {
      ...
      // Append tracking parameters to matching server keys
      form.append('did_comment', actions.didComment);
      form.append('did_repost', actions.didRepost);
      form.append('did_share', actions.didShare);
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col gap-4 mt-5 pt-4 border-t border-slate-200 dark:border-slate-700">
                  {/* Inline Option Selectors for Interns */}
                  {user?.role === 'INTERN' && (
